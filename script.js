...
const botModel = async (userId, input) => {
  ...
  if(!relevantData ){
    ...
    prompt = `You are designated to answer the prompt with respect to the context provided here. context: ${relevantData}, user input:${input}. Do not make up any information.`;
  }
  if (!chats.has(userId)) {
